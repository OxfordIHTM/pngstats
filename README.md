...
# pngstats: Statistics from the Papua New Guinea National Statistical Office (NSO)
...
[`R`](https://cran.r-project.org/) workflow for the curation of
statistics data from the Papua New Guinea National Statistical Office.
